...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2018 a las 09:16:31
...
--
ALTER TABLE `quest`
  MODIFY `fol_int` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
COMMIT;
