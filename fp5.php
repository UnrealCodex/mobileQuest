...
<input type="hidden" name="num" value="<?php echo $_REQUEST['num'] ; ?>">			
			...
			<div class="form-group" align="left">
        			<label for="fp5_54" >118.¿Dentro de su hogar tiene mascotas?</label>
    				<div>
			...
			<div class="form-group" align="left">
    				...
    				<div id="radioBtn" class="btn-group">
						<div id="dhp5_56">
						<a class="btn btn-primary btn-sm notActive" style="font-size: 32px" data-toggle="p5_56" data-title="0">No   </a>
                        <a class="btn btn-primary btn-sm notActive" style="font-size: 32px" data-toggle="p5_56" data-title="1">Si    </a>
...
<!-- PREGUNTA CON OPCION  61 -->			
 ...
 <div class="form-group" align="left">
			...
			<div class="form-group" align="left" id="ep5_62" hidden>
        			<label for="fp5_62" >87. ¿De donde obtiene el agua?</label>
    				<div>
    				<div class="input-group">
    				<div id="radioBtn" class="btn-group">
						<table>
